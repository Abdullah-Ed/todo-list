...
class FormHandler {
  static createTodo = (event) => {
    ...
    _createTodo__WEBPACK_IMPORTED_MODULE_0__.ArraysManager.updateDatesArray()
    ...
    _UI__WEBPACK_IMPORTED_MODULE_1__.FormControl.hideForm(event)
  }
...
class ProjectHandler{
  ...
  static createProject = (event) => {
    ...
    _UI__WEBPACK_IMPORTED_MODULE_1__.FormControl.hideProjectForm(event)
    form.reset();
...
static editTodo(id) {
  ...
  const indexInAllTodos = _createTodo__WEBPACK_IMPORTED_MODULE_0__.TodosArrays.allTodosArray.findIndex(todo => todo.id == id);
...
class ArraysManager extends TodosArrays {
  static addToTodayArray() {
    TodosArrays.todayTodoArray = TodosArrays.allTodosArray.filter((todo) => (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(todo.dueDate)) ==true);
  }

  static addToCurrentWeekArray() {
    TodosArrays.currentWeekTodoArray = TodosArrays.allTodosArray.filter((todo) => {
      return (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(todo.dueDate)) == true ;
    });
  }
