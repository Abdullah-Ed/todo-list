...
class FormHandler {
  static createTodo = (event) => {
    ...
    _createTodo__WEBPACK_IMPORTED_MODULE_0__.TodosArrays.addToArray(newTodo);
    console.log(_createTodo__WEBPACK_IMPORTED_MODULE_0__.TodosArrays.allTodosArray);
    _createTodo__WEBPACK_IMPORTED_MODULE_0__.ArraysManager.updateArrays();
    _UI__WEBPACK_IMPORTED_MODULE_1__.StyleControl.changePriorityStyle();
    _UI__WEBPACK_IMPORTED_MODULE_1__.TabHandler.updateCurrentArray();
    _UI__WEBPACK_IMPORTED_MODULE_1__.TodoManager.renderTodosOnPage(_UI__WEBPACK_IMPORTED_MODULE_1__.TodoRenderer.currentArray);
    _UI__WEBPACK_IMPORTED_MODULE_1__.StyleControl.hideForm(event);
  };
  ...
  static createTodoFromForm(form) {
    ...
    return new _createTodo__WEBPACK_IMPORTED_MODULE_0__.Todos(
      title.value,
      description.value,
      dueDate.value,
      priority.value,
...
class ProjectHandler {
  ...
  static createProject = (event) => {
    ...
    _UI__WEBPACK_IMPORTED_MODULE_1__.StyleControl.hideProjectForm(event);
    form.reset();
  };
  ...
  static renderProjects() {
    ...
    const projects = _UI__WEBPACK_IMPORTED_MODULE_1__.TabHandler.getAllLi();
    if (!document.querySelector(".currentProject") && projects.length > 0) {
      projects[projects.length - 1].classList.add("currentProject");
      _UI__WEBPACK_IMPORTED_MODULE_1__.TabHandler.loadUserProjectTodos();
    }
    if (this.projectArray == 0) {
      _UI__WEBPACK_IMPORTED_MODULE_1__.TabHandler.loadWeeksTodos();
    }
  }
  ...
  static AddProjectToForm() {
    ...
    _UI__WEBPACK_IMPORTED_MODULE_1__.TabHandler.liClickEvent();
    _UI__WEBPACK_IMPORTED_MODULE_1__.TabHandler.AddEventToProject();
    _createTodo__WEBPACK_IMPORTED_MODULE_0__.Storage.storeProjects();
  }
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   StyleControl: () => (/* binding */ StyleControl),
...
/* harmony import */ var _FormHandel__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./FormHandel */ "./src/FormHandel.js");




class TodoRenderer {
  static currentArray = _createTodo__WEBPACK_IMPORTED_MODULE_0__.TodosArrays.allTodosArray;
  ...
  static renderTodo(todo) {
    ...
    <div class="todo-container">
      ...
      <div>
        ...
        <p>${(0,date_fns_format__WEBPACK_IMPORTED_MODULE_2__["default"])(new Date(todo.dueDate), "dd/MM/yyyy")}</p>
...
class TodoManager {
  ...
  static changeStatus(id) {
    ...
    _createTodo__WEBPACK_IMPORTED_MODULE_0__.TodosArrays.allTodosArray.forEach((todo, currentIndex) => {
      if (todo.id == id) {
  ...
  static deleteTodo(id) {
    ...
    _createTodo__WEBPACK_IMPORTED_MODULE_0__.TodosArrays.allTodosArray.forEach((todo, currentIndex) => {
      if (todo.id == id) {
        ...
        _createTodo__WEBPACK_IMPORTED_MODULE_0__.TodosArrays.allTodosArray.splice(indexInAllTodos, 1);
  ...
  static editTodo(id) {
    ...
    const indexInAllTodos = _createTodo__WEBPACK_IMPORTED_MODULE_0__.TodosArrays.allTodosArray.findIndex(
      (todo) => todo.id == id
    );
    const todo = _createTodo__WEBPACK_IMPORTED_MODULE_0__.TodosArrays.allTodosArray[indexInAllTodos];
  ...
  `;
    ...
    saveButton.addEventListener("click", () => {
      if (!_FormHandel__WEBPACK_IMPORTED_MODULE_1__.FormHandler.validateForm(editForm)) return;
      const updatedTodo = {
      ...
      _createTodo__WEBPACK_IMPORTED_MODULE_0__.TodosArrays.allTodosArray[indexInAllTodos] = updatedTodo;
      _createTodo__WEBPACK_IMPORTED_MODULE_0__.ArraysManager.updateArrays();
      TabHandler.updateCurrentArray();
      this.renderTodosOnPage(TodoRenderer.currentArray);
    });
...
class TabHandler {
  ...
  static loadHomeTodos() {
    ...
    TodoRenderer.currentArray = _createTodo__WEBPACK_IMPORTED_MODULE_0__.TodosArrays.allTodosArray;
  ...
  static loadTodayTodos() {
    TabHandler.emptyContent();
    TodoRenderer.currentArray = _createTodo__WEBPACK_IMPORTED_MODULE_0__.TodosArrays.todayTodoArray;
    TodoManager.renderTodosOnPage(TodoRenderer.currentArray);
    TabHandler.changTabHeader();
  }
  ...
  static loadWeeksTodos() {
    TabHandler.emptyContent();
    TodoRenderer.currentArray = _createTodo__WEBPACK_IMPORTED_MODULE_0__.TodosArrays.currentWeekTodoArray;
    TodoManager.renderTodosOnPage(TodoRenderer.currentArray);
    TabHandler.changTabHeader();
  }
  ...
  static loadUserProjectTodos() {
    TabHandler.emptyContent();
    _createTodo__WEBPACK_IMPORTED_MODULE_0__.ArraysManager.updateProjectArray();
    TodoRenderer.currentArray = _createTodo__WEBPACK_IMPORTED_MODULE_0__.TodosArrays.userProjectsArray;
    TodoManager.renderTodosOnPage(TodoRenderer.currentArray);
    TabHandler.changTabHeader();
  }
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   ArraysManager: () => (/* binding */ ArraysManager),
...
class ArraysManager extends TodosArrays {
  static addToTodayArray() {
    TodosArrays.todayTodoArray = TodosArrays.allTodosArray.filter(
      (todo) => (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(todo.dueDate)) == true
    );
  }
  ...
  static addToCurrentWeekArray() {
    TodosArrays.currentWeekTodoArray = TodosArrays.allTodosArray.filter(
      (todo) => {
        return (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(todo.dueDate)) == true;
      }
    );
  }
...
class Storage {
  ...
  static storeProjects() {
    localStorage.setItem(
      "projectsArray",
      JSON.stringify(_FormHandel__WEBPACK_IMPORTED_MODULE_0__.ProjectHandler.projectArray)
    );
  }

  static getStoredProjects() {
    _FormHandel__WEBPACK_IMPORTED_MODULE_0__.ProjectHandler.projectArray =
