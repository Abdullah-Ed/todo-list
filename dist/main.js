...
class FormHandler {
  ...
  static createTodoFromForm(form) {
    ...
    return new _createTodo__WEBPACK_IMPORTED_MODULE_0__.Todos(title.value, description.value, dueDate.value, priority.value,project.value);
  }
