...
class TodoManager {
  ...
  static renderTodos() {
    this.content.innerHTML = _createTodo__WEBPACK_IMPORTED_MODULE_0__.TodosArrays.allTodosArray.map((todo, index) => {
      return TodoRenderer.renderTodo(todo, index);
    }) 
    _createTodo__WEBPACK_IMPORTED_MODULE_0__.Dates.addToTodayArray()
    console.log(_createTodo__WEBPACK_IMPORTED_MODULE_0__.Dates.todayTodoArray)
    _createTodo__WEBPACK_IMPORTED_MODULE_0__.Dates.addToCurrentWeekArray();
    console.log(_createTodo__WEBPACK_IMPORTED_MODULE_0__.Dates.currentWeekTodoArray)
  }

  static deleteTodo(index) {
    _createTodo__WEBPACK_IMPORTED_MODULE_0__.TodosArrays.allTodosArray.splice(index, 1);
    this.renderTodos();
  }
  ...
  static editTodo(index) {
    ...
    const todo = _createTodo__WEBPACK_IMPORTED_MODULE_0__.TodosArrays.allTodosArray[index];
    ...
    saveButton.addEventListener('click', () => {
      ...
      _createTodo__WEBPACK_IMPORTED_MODULE_0__.TodosArrays.allTodosArray[index] = updatedTodo;
      this.renderTodos();
    });
  }
}
