...
class FormHandler {
  ...
  static createTodo = (event) => {
    ...
    _createTodo__WEBPACK_IMPORTED_MODULE_0__.Dates.updateDatesArray()
  ...
  static createTodoFromForm(form) {
    ...
    return new _createTodo__WEBPACK_IMPORTED_MODULE_0__.Todos(title.value, description.value, dueDate.value, priority.value);
  }
...
static editTodo(id) {
  ...
  saveButton.addEventListener('click', () => {
    if (!_FormHandel__WEBPACK_IMPORTED_MODULE_1__["default"].validateForm(editForm)) return;
    const updatedTodo = {
...
addProjectBtn.addEventListener('click', _FormHandel__WEBPACK_IMPORTED_MODULE_0__["default"].createTodo);

_UI__WEBPACK_IMPORTED_MODULE_1__.TodoManager.initialize();
_UI__WEBPACK_IMPORTED_MODULE_1__.TodoManager.renderTodosOnPage(_UI__WEBPACK_IMPORTED_MODULE_1__.TodoRenderer.currentArray);

const createProjectBtn =document.querySelector('.project-btn');
createProjectBtn.addEventListener('click',_FormHandel__WEBPACK_IMPORTED_MODULE_0__["default"].createProject)
